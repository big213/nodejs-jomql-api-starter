...
export abstract class Service {
  ...
  static async subscribeToSingleItem(
    ...
    const channel = await subscriptionHelper.handleJqlSubscription(
      req,
      operationName,
      validatedArgs,
  ...
  static async subscribeToMultipleItem(
    operationName: string,
    req,
    args,
    query?: object,
  ...
  static async deleteRecord(req, args = <any>{}, query?: object) {
    ...
    await subscriptionHelper.handleJqlSubscriptionTrigger(
      req,
      this,
    ...
    await subscriptionHelper.deleteJqlSubscription(
      req,
      this.__typename + "Deleted",
      validatedArgs
    );
